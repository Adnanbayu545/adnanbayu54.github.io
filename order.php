                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="inputnamaproduk" name="namaproduk" required>
                            <option value="Produk1">1. Nike Air Force</option>
                            <option value="Produk2">2. Nike Air Robix</option>
                            <option value="Produk3">3. Nike Air Max</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="inputhargaproduk">Harga Produk</label>
                        <input type="text" class="form-control" id="inputhargaproduk" name="hargaproduk" value="120.000" readonly>
                     </div>
                    <div class="form-group">
